...
for article in my_dict['response']['results']:
    article['views'] = 0

print(my_dict['response']['results'])
...
def read_article(dict):
    random_article = random.randint(0, len(my_dict['response']['results']))
    my_dict['response']['results'][random_article]['views'] += 1
    return dict

print(read_article(my_dict))
print(read_article(my_dict))
print(read_article(my_dict))
...
def display_views(dict):
    for x in range(len(my_dict['response']['results'])):
        views_dict = my_dict['response']['results'][x]
        print(f"{views_dict['webTitle']}")
        print(f"read {views_dict['views']} times")

display_views(my_dict)
display_views(my_dict)
display_views(my_dict)